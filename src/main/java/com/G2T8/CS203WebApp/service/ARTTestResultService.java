...
public class ARTTestResultService {
    ...
    public ARTTestResult addART(String email, Boolean artResult) {
        ...
        ARTTestResult newArtTestResult = new ARTTestResult(userEntity, artResult, date,
                date.toLocalDate().with(TemporalAdjusters.previous(DayOfWeek.MONDAY)));
     ...
     * @param date  find all ART test results submitted by user during the week this
     *              date is in
     * @return List of ARTTestResults of user with email email submitted on the week
     *         of date
     */
     ...
     * @param date find all ART test results submitted by user during the week this
     *             date is in
     * @return List of ARTTestResults of user user submitted on the week of date
     */
